...
for i in range(Nruns):
    ...
    Zsd,Xsd=base.pcn_state_dependent_PT(post,N,beta,sigma_is,PRIOR,x0,Ns=1,Disp=1,dim_q=7) #State dependent
...
name_q='results/est_sd_'+str(INDICATOR).zfill(2)+'.npy'

np.save(name_q,mean_sd)
