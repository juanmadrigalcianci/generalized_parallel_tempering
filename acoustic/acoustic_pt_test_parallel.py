...
Xptf=base.full_vanilla(post,N,beta,sigma_is,x0.T,Ns=1,Disp=1) #full vanilla, reversible
mean_pt=np.mean(Xptf[Burn_in:,:,0],0)
np.save('mean_pt_acoustic_'+str(id_proc).zfill(3)+'.npy',mean_pt)      
