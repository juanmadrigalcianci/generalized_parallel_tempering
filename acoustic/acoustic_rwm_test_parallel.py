...
print('----------------------------------')
Xrwm=base.rwm(post,N*N_temp,sigma_rwm,x0[0,:],Disp=1) #random walk metropolis
mean_rwm=np.mean(Xrwm[Burn_in:,:],0)
np.save('mean_rwm_acoustic_'+str(id_proc).zfill(3)+'.npy',mean_rwm)   
