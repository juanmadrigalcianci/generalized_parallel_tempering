...
Xuw=base.unweighted_IS(post,N,beta,sigma_is,x0.T,Ns=1,Disp=1) #full vanilla, reversible
mean_uw=np.mean(Xuw[Burn_in:,:,0],0)
np.save('mean_uw_acoustic_'+str(id_proc).zfill(3)+'.npy',mean_uw)      
