...
Xsd=base.state_dependent_PT(post,N,beta,sigma_is,x0.T,Ns=1,Disp=1) 
mean_sd=np.mean(Xsd[Burn_in:,:,0],0)
np.save('mean_sd_acoustic_'+str(id_proc).zfill(3)+'.npy',mean_sd)      
